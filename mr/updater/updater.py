...
import mr.srcfetcher as srcfetcher
import mr.updater.relmon as relmon
import mr.updater.arch as arch
...
class Updater:
    def __init__(self, relmon_db, srcfetcher_db):
        ...
        self.relmon = mr.relmon.Relmon(relmon_db)
        self.config = mr.config.Config('updater').read()
...
def main():
    with mr.db.DB('relmon') as relmon_db, mr.db.DB('srcfetcher') as srcfetcher_db:
